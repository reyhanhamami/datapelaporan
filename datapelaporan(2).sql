...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Nov 27, 2019 at 01:37 PM
...
('c4e05208-c8b4-4610-91d0-1d0ec52f6bce', 'tes1', NULL, '32', '9f67f5c0-9d4c-4e1e-97d7-1b4b25139415', '10000', '2019-10-13 03:48:19', '2019-10-13 03:48:19'),
('924e4a9c-14d4-4730-a864-6083a472b602', 'AL HARAMAIN AMBER15 ML', '1570198823.jpg', '3268', '17fd4fb6-f7ca-47f0-87e1-60e3955560dc', '2500', '2019-10-04 14:20:23', '2019-10-04 14:20:23'),
('b2a4ebc8-0700-499e-a2d2-35022d638298', 'AL HARAMAIN BADAR15 ML', '1570198859.jpg', '2', '17fd4fb6-f7ca-47f0-87e1-60e3955560dc', '1000', '2019-10-04 14:21:00', '2019-10-04 14:21:00'),
('a98d20cb-c07f-4cce-9976-afe00533e108', 'handuk', NULL, '3', '686515bc-32a3-408c-ae4c-031d7c2a8d0b', '100000', '2019-10-27 04:43:46', '2019-10-27 09:31:22'),
('265dab0a-b074-4192-980d-ecbe7371c83e', 'Parfum', '2019-10-27,055834.jpg', '34', '9f67f5c0-9d4c-4e1e-97d7-1b4b25139415', '40000', '2019-10-26 22:58:35', '2019-10-27 09:31:11');
...
(243, '10', '24112019213556', 'c4e05208-c8b4-4610-91d0-1d0ec52f6bce', 29000, 3, NULL, '2019-11-24 14:35:56', '2019-11-24 14:35:56'),
(244, '10', '24112019213556', '924e4a9c-14d4-4730-a864-6083a472b602', 5000, 2, NULL, '2019-11-24 14:35:56', '2019-11-24 14:35:56'),
(245, '10', '24112019213834', 'a98d20cb-c07f-4cce-9976-afe00533e108', 100000, 1, NULL, '2019-11-24 14:38:34', '2019-11-24 14:38:34'),
(246, '10', '24112019213834', '924e4a9c-14d4-4730-a864-6083a472b602', 5000, 2, NULL, '2019-11-24 14:38:34', '2019-11-24 14:38:34'),
(242, '10', '23112019220626', 'b2a4ebc8-0700-499e-a2d2-35022d638298', 3000, 3, NULL, '2019-11-23 15:06:26', '2019-11-23 15:06:26'),
(240, '10', '23112019203807', 'c4e05208-c8b4-4610-91d0-1d0ec52f6bce', 50000, 5, 'packing rapih', '2019-11-23 13:38:07', '2019-11-23 13:38:07'),
(241, '10', '23112019203807', 'a98d20cb-c07f-4cce-9976-afe00533e108', 50000, 1, 'Diskon dropship', '2019-11-23 13:38:07', '2019-11-23 13:38:07');

--
-- Triggers `barang_order`
--
DROP TRIGGER IF EXISTS `decrease-barang-when-order`;
DELIMITER $$
CREATE TRIGGER `decrease-barang-when-order` AFTER INSERT ON `barang_order` FOR EACH ROW BEGIN
	UPDATE barang SET stock_barang = stock_barang - NEW.stock_berkurang
    where id_barang = NEW.id_barang;
END
$$
DELIMITER ;
DROP TRIGGER IF EXISTS `increase-barang-when-orderbatal`;
DELIMITER $$
CREATE TRIGGER `increase-barang-when-orderbatal` AFTER DELETE ON `barang_order` FOR EACH ROW UPDATE barang SET stock_barang = barang.stock_barang + old.stock_berkurang where barang.id_barang = old.id_barang
$$
DELIMITER ;
...
CREATE TABLE IF NOT EXISTS `bukti_pembayaran` (
  ...
  `id_reseller` varchar(150) NOT NULL,
  `id_customer` varchar(150) NOT NULL,
  `total` varchar(100) NOT NULL,
  `input_bukti` varchar(255) DEFAULT NULL,
  `foto_bukti` varchar(255) DEFAULT NULL,
  `status_bukti` varchar(50) DEFAULT NULL,
...
INSERT INTO `bukti_pembayaran` (`id_pembayaran`, `id_order`, `id_reseller`, `id_customer`, `total`, `input_bukti`, `foto_bukti`, `status_bukti`, `created_at`, `updated_at`) VALUES
(4, '24112019213556', '10', 'a06dc782-1362-414c-bdd7-d356c2b94a06', '0', NULL, '2019-11-24,215744.jpg', 'iya', '2019-11-24 14:35:56', '2019-11-24 14:57:55'),
(5, '24112019213834', '10', 'd914632c-ce51-44cf-97ce-92c52f1cdcd0', '116000', NULL, NULL, NULL, '2019-11-24 14:38:34', '2019-11-24 14:38:34');
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `foto_order` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `order` (`id_order`, `tanggal_order`, `reseller_order`, `pengirim_order`, `telepon_order`, `ecommerce_order`, `expedisi_order`, `ongkir_order`, `total_order`, `customer_order`, `resiotomatis_order`, `foto_order`, `created_at`, `updated_at`) VALUES
('23112019220626', 'Sat,23-Nov-2019', '10', NULL, NULL, '260181ca-6501-4ae6-9044-b149ec20eb6d', '00c79b07-096c-4ace-b4e4-8d47ccaadb45', '1000', '4000', 'd914632c-ce51-44cf-97ce-92c52f1cdcd0', 'TesResiTerinput', '2019-11-24,210541.jpg', '2019-11-23 15:06:26', '2019-11-24 14:05:41'),
('24112019213556', 'Sun,24-Nov-2019', '10', NULL, NULL, '8f781715-2c8b-412f-b288-8b058306c621', '00c79b07-096c-4ace-b4e4-8d47ccaadb45', '1111', '35111', 'a06dc782-1362-414c-bdd7-d356c2b94a06', 'TesResiTerinput', NULL, '2019-11-24 14:35:56', '2019-11-24 14:35:56'),
('24112019213834', 'Sun,24-Nov-2019', '10', NULL, NULL, '8f781715-2c8b-412f-b288-8b058306c621', '47d70b36-22b8-42e0-8461-38365ac8aaaf', '11000', '116000', 'd914632c-ce51-44cf-97ce-92c52f1cdcd0', 'R3sssiq2A', NULL, '2019-11-24 14:38:34', '2019-11-24 14:38:34'),
('23112019203807', 'Sat,23-Nov-2019', '10', 'Tes Dropship', '081522211221', '260181ca-6501-4ae6-9044-b149ec20eb6d', '00c79b07-096c-4ace-b4e4-8d47ccaadb45', '11000', '111000', 'c24ed1a7-d9dc-4d88-b973-9217578cb385', 'tesresi', NULL, '2019-11-23 13:38:07', '2019-11-23 13:38:07');
...
(1, 'Admin', 'admin@bwa.id', '082211', NULL, '$2y$10$U6FwktczBDgZdC.wV8GR7eCdSdmfcHasBKTkfFsF6MoZ/i5HXKsJO', NULL, 'admin', 'admin', 'ZFhChsHfgum8gRQ741W4yBOA29EVcuO2svM9SA4ADCIW8KkdIJnca5xDD8wp', '2019-09-17 05:46:27', '2019-09-29 14:07:55'),
(10, 'Reseller', 'reseller@gmail.com', '0812939393', NULL, '$2y$10$J9L10UA54ApTrT2KuHzz7ej9tEYYx8pQQKFLUqIiJcfYkSW8g.TEW', '1569762906-sizecooporatepersonal4-02.jpg', 'OliShop', 'reseller', NULL, '2019-09-29 01:17:39', '2019-09-29 06:18:23'),
(12, 'Gudang', 'gudang@gmail.com', '0899122211', NULL, '$2y$10$GVTBe/70Iv1cBNxCpwEwe.ty96R3z6.i8SfprmMSXhkvnv9O1FRiG', '2019-09-29,203415.png', 'Berkah Ramadhan', 'gudang', NULL, '2019-09-29 06:23:31', '2019-09-29 13:34:15'),
